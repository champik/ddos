...
const editExists = fs.existsSync(path.join(projectDir, 'edit/edit.html'));
...
const links = [
  `<a class="btn btn-review" href="${hrefPrefix}/review/review.html">Review</a>`,
  editExists ? `<a class="btn btn-edit" href="${hrefPrefix}/edit/edit.html">✏️ Edit</a>` : null,
].filter(Boolean);
